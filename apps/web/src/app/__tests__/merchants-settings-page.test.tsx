...
import MerchantsSettingsPage from '../(dashboard)/settings/merchants/page';

describe('MerchantsSettingsPage', () => {
  it('should render the Merchants heading', () => {
    render(<MerchantsSettingsPage />);
