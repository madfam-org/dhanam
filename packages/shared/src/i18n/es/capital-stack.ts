export const capitalStack = {
  ...
  journal: {
    ...
    actions: 'Acciones',
    match: 'Conciliar',
    matchTitle: 'Conciliar transacción de negocio',
    matchHint: 'Pega el ID de la transacción del lado negocio',
    matchSubmit: 'Confirmar conciliación',
    sendKarafiel: 'Enviar a Karafiel',
    sentKarafiel: 'Enviado a Karafiel para cumplimiento',
    matchSuccess: 'Diario conciliado',
    targetTxnId: 'ID de transacción destino',
    cancel: 'Cancelar',
  },
  spaces: {
