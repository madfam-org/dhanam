export const capitalStack = {
  ...
  journal: {
    ...
    actions: 'Ações',
    match: 'Conciliar',
    matchTitle: 'Conciliar transação empresarial',
    matchHint: 'Cole o ID da transação do lado empresarial',
    matchSubmit: 'Confirmar conciliação',
    sendKarafiel: 'Enviar ao Karafiel',
    sentKarafiel: 'Enviado ao Karafiel para conformidade',
    matchSuccess: 'Diário conciliado',
    targetTxnId: 'ID da transação destino',
    cancel: 'Cancelar',
  },
  spaces: {
