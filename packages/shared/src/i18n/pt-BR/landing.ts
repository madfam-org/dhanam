  ...
  pricing: {
    ...
    community: {
      ...
      features: [
        ...
        'Simulações e cálculos ESG ilimitados',
    ...
    essentials: {
      ...
      features: [
        ...
        'Espaços ilimitados (pessoal + negócios)',
        '3 conexões com provedores (Belvo + Bitso)',
        '10 simulações por dia',
        'Categorização com IA',
        'Previsão de fluxo de caixa de 60 dias',
        'Pontuação ESG cripto',
    ...
    pro: {
      ...
      features: [
        ...
        '12 cenários históricos de estresse',
        'Planejamento patrimonial e Life Beat',
        'Visões do lar (Seu / Meu / Nosso)',
        'Portfolio gaming e metaverso',
        'Avaliação de colecionáveis (7 categorias)',
        'Cofre de documentos',
        'Busca IA (⌘K)',
        'Sistema de conquistas',
        'Relatórios agendados e exportação PDF/CSV',
        'Suporte prioritário',
      ],
      ctaText: 'Iniciar Teste de 14 Dias',
    },
    premium: {
      ...
      features: [
        'Tudo no Pro, mais:',
        '10 espaços financeiros',
        '50.000 iterações Monte Carlo',
        '24 cenários históricos de estresse',
        '25 GB de armazenamento de documentos',
